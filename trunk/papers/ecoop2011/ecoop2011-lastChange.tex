...
\subsection{Developers can learn to use \protect\textit{lastChange}}
...
\subsection{In most cases \protect\textit{lastChange} will be much faster than current alternatives}
...
\subsubsection*{Acknowledgments.} The authors thank Leo Meyerovich for reading a draft of this paper and suggesting the example in section \ref{sec:resultConsistency} and

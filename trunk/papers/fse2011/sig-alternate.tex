...
\includegraphics[width=.48\textwidth]{5-example-points.png}
...
\begin{figure}[htp]
\centering 
\includegraphics [width=.48\textwidth] {6-foo-changes1.png} %[width=.48\textwidth][scale=0.75]
...
\begin{figure}[htp]
\centering 
\includegraphics[width=.40\textwidth]{7-foo-changes2.png}
...
\begin{figure}[htp]
\centering 
\includegraphics[width=.48\textwidth]{8-lastchange-lastchange.png}

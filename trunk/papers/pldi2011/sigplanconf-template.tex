...
\authorinfo{First Author}
           {AAA university}
           {a@a.com}

\authorinfo{Second Author}
           {BBB company}
           {b@b.com}

\authorinfo{Third Author}
           {CCC university}
           {c@c.com}
...
the \textit{lastChange} results in section 5. %TODO update it according to new
Section 6 contains an evaluation of\text{lastChange} functionality.
...
\subfigure[The result of \textit{lastChange} query for
  \texttt{myCondition.value}. To evaluate an expression (e.g., oldValue) at this point, developer can

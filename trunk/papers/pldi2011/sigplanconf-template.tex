...
algorithm ends. The ability to identify this reproduction point, i.e.
 a test case and a breakpoint after the bug is appears, is the only
...
The Firefox JavaScript engine provides a JavaScript debugging interface [] and %\cite{JSD}
...
property changes in the object.  Setting a flag[] into the Firefox %\cite{JSD}

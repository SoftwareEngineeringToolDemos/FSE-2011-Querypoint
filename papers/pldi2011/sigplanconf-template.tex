...
JavaScript, a code block can be identified by the file url the 
the block's first program counter. Given this information, debugger is
...
If developer asks for the last change of \texttt{foo} at the 
...
Firebug itself is an extension of the Firefox browser[]. %\cite{firefox-version-3.6}
The Firefox JavaScript engine provides a JavaScript debugging interface and

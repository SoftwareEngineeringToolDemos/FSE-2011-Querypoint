...
The third function (defined in line 14), is passed as an argument to another function with name {\small\texttt{op}}. This function contributes in producing the {\small\texttt{result}} value. Therefore, the summary will be {\small\texttt{main</return/result<}} and the function is named as {\small\texttt{main</result<}}.

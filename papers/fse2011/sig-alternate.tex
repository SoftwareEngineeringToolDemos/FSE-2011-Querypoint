...
\alignauthor
Salman Mirghasemi\\
       \affaddr{\'Ecole Polytechnique F\'ed\'erale de Lausanne, Switzerland}\\
...
time, reducing development costs  and improve software quality.
...
Niether approach assists the developer in finding origins to a wrong
value.
...
The \textit{lastChange} algorigthm provides information on important program
...
program and break again on line 22, analyzes it queries and shows the developer line 25-the
...
\section{{\large\bf\textit{lastChange}} Algorithm}
...
\subsection{{\large\bf\texttt{objectId()}} operation}
...
\subsection{{\large\bf\texttt{setPropertyChangeHook()}} operation}
...
\subsection{{\large\bf\texttt{scopeId()}} operation}
...
\subsection{{\large\bf\texttt{setVariableChangeHook()}} operation}
